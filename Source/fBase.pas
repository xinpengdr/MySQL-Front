...
const
  ...
  CM_CHANGEPREFERENCES = WM_USER + 400;
  CM_POSTSHOW = WM_USER + 401;
  CM_POSTRESIZE = WM_USER + 402;
  CM_RENAME = WM_USER + 403;
  CM_ADDTAB = WM_USER + 404;
  CM_CLOSE_TAB_QUERY = WM_USER + 405;
  CM_CLOSE_TAB = WM_USER + 406;
  CM_UPDATEPROGRESSINFO = WM_USER + 407;
  CM_EXECUTIONDONE = WM_USER + 408;
  CM_DEACTIVATETAB = WM_USER + 409;
  CM_APPLYAUTOSIZE = WM_USER + 410;
  CM_BEFORE_RECEIVING_DATASET = WM_USER + 411;
  CM_AFTER_RECEIVING_DATASET = WM_USER + 412;

...
const
  ...
  CM_ACTIVATEFRAME = WM_USER + 100;
  CM_ADDTAB = WM_USER + 101;
  CM_APPLYAUTOSIZE = WM_USER + 103;
  CM_BOOKMARKCHANGED = WM_USER + 104;
  CM_CHANGEPREFERENCES = WM_USER + 105;
  CM_CLOSE_TAB = WM_USER + 106;
  CM_CLOSE_TAB_QUERY = WM_USER + 107;
  CM_DEACTIVATETAB = WM_USER + 108;
  CM_DEACTIVATEFRAME = WM_USER + 109;
  CM_EXECUTE = WM_USER + 110;
  CM_EXECUTIONDONE = WM_USER + 111;
  CM_POSTRESIZE = WM_USER + 112;
  CM_POSTSHOW = WM_USER + 113;
  CM_RENAME = WM_USER + 114;
  CM_UPDATEPROGRESSINFO = WM_USER + 115;
  CM_UPDATETOOLBAR = WM_USER + 116;
